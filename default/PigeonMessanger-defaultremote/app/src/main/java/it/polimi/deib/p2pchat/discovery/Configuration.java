...
public class Configuration {
    ...
    public static final String OUT_REMOTE_CLIENT_MSG = "outremoteclient";
    public static final String OUT_REMOTE_REPLY_MSG = "outremotemsg_reply";
    public static final String IN_REMOTE_ACCESS_RESPONSE = "inremoteaccess_response";
