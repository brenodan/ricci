...
public class MainActivity extends AppCompatActivity implements
    ...
    private static BasicBroadcastReceiver basicReceiver = null;

    private RemoteAssistant remoteAssistant;
    public boolean amIOnlineFlag = false;
    ...
    public static void checkRemoteResultsHolder(){
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                while( basicReceiver.remoteResultsHolder == null) {

                    System.out.println("Waiting for response");
                    sleep(150);

                }
                System.out.println("@@ " + basicReceiver.remoteResultsHolder.toString());
                System.out.println("@@ " + basicReceiver.remoteResultsHolder.getGetAction());
                System.out.println("@@ " + basicReceiver.remoteResultsHolder.getGetDataToString());
                System.out.println("@@ " + basicReceiver.remoteResultsHolder.getGetBundleKeys());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case RETURN_CODE: {
                ...
                Log.d(TAG, "REQUEST REMOTE TRANSMISSION");
                if(data != null){
                    Intent intent = handleRemoteIntent(data);
                    startService(intent);
...
//    }
    ...
    public static void configureBasicBroadcastReceiver(RemoteAssistant remoteAssistant, Object object) {

        basicReceiver.setRemoteAssistant(remoteAssistant);
        basicReceiver.setRemoteSerializableObject(object);
    }
