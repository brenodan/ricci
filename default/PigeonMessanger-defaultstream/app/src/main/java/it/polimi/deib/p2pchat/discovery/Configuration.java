...
public class Configuration {
    ...
    public static final String MESSAGEEXCHANGE = "_+_exchange_+_message_+_";
    public static final String MESSAGERETURN = "_+_ex_-_return_-_message_+_";

    public static final String IN_MSG = "+_+_---in_msg@#$";
    public static final String OUT_MSG = "+_+_-out_msg@#$__";
    public static final String OUT_STREAM_REPLY_MSG = "@#$$%%_--out_stream";
    public static final String OUT_STREAM_FILE_CLIENT_MSG = "##$%*(--outfilestreamclientmsg";
    public static final String OUT_STREAM_CLIENT_MSG = "#@@#OUT_STREAM_CLIENT_MSG";
    public static final String OUT_STREAM_FILE_REPLY_MSG = "@@##@#@OUT_STREAM_FILE_REPLY_MSG";
    public static final String IN_STREAM_ACCESS_RESPONSE = "##@@#$!___instream__access__response";
