...
public class IntentSerialization {
    ...
    private static final String TAG = "IntentSerialization";

    private IntentSerialization(){}
    ...
    public static Intent deserializeIntentGson(String message) {
    ...
    public static Intent deserializeIntentGsonURI(String message) {
    ...
    public static Intent deserializeIntentGsonBundle(String message) {
    ...
    public static Bundle bundleStringProcessing(String message){
    ...
    public static String serializeIntentGson(Intent myObject) {
    ...
    public static class BundleDeserializer implements JsonDeserializer<Bundle> {
        @Override
    ...
    public static Bundle prepareJsonBundle(Bundle bundle){
    ...
    public static byte[] returnByteArrayFromString(String inputString){
    ...
    public static Intent returnRemoteIntentFromByteArray(byte[] inputBytes){
