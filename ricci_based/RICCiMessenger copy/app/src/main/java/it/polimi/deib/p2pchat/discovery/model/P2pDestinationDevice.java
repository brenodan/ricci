 ...
 * This class is useful because can be used to extend the basic {@code WifiP2pDevice}'s
 * functionality to include the ip address, that is not available in the original Android's API.
