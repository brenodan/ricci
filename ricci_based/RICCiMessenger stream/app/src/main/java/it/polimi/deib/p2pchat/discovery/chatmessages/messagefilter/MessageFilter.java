...
public class MessageFilter {
     ...
     * @throws MessageException Exception thrown if the message is null or if it's too short or
     *                          if it's blacklisted.
     */
