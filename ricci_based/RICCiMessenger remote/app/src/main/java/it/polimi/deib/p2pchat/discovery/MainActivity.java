...
public class MainActivity extends RicciAppCompatActivity
    ...
    private static BasicIntentBroadcastReceiver ricciReceiver = null;
    private Thread socketHandler;
    private final Handler handler = new Handler(this);

    public static void configureRicciBroadcastReceiver(RemoteAssistant remoteAssistant, Object object) {

            ricciReceiver.setRemoteAssistant(remoteAssistant);
            ricciReceiver.setRemoteSerializableObject(object);
    }
    ...
    public static void checkRemoteResultsHolder(){
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                while( ricciReceiver.remoteResultsHolder == null) {
                ...
                System.out.println("@@ " + ricciReceiver.remoteResultsHolder.getGetgetAction());
                System.out.println("@@ " + ricciReceiver.remoteResultsHolder.getGetgetDataString());
                System.out.println("@@ " + ricciReceiver.remoteResultsHolder.getGetgetAction());
                System.out.println("@@ " + ricciReceiver.remoteResultsHolder.getGetgetScheme());
                System.out.println("@@ " + ricciReceiver.remoteResultsHolder.getGetgetType());
                System.out.println("@@ " + ricciReceiver.remoteResultsHolder.getGetgetFlags());
    ...
    public void onPause() {
        super.onPause();
        unregisterReceiver(ricciReceiver);
